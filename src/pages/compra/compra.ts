...
export class CompraPage {
  ...
  finalizarPedido(){
    //Cria uma função que vai mandar o array 'carrinho' e o 'preco'
    //pra próxima página (a de confirmação de pagamento).

    //Daí depois da confirmação de pagamento pode vir uma tela fake de colocar info de cartão.
    //E depois da fake a 'confirmação da compra'.
  }
